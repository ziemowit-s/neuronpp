...
extern void _syn_4p_reg();
extern void _syn_4p_ach_da_reg();
extern void _syn_ach_reg();
extern void _syn_da_reg();
...
fprintf(stderr," syn_4p.mod");
fprintf(stderr," syn_4p_ach_da.mod");
fprintf(stderr," syn_ach.mod");
fprintf(stderr," syn_da.mod");
