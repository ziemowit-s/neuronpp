...
if __name__ == '__main__':
    ...
    for s, h in zip(syns_4p, heads):
        syn_ach = cell.add_sypanse(source=stim1, mod_name="SynACh", seg=h(1.0), weight=0.1, delay=1)
        syn_da = cell.add_sypanse(source=stim2, mod_name="SynDa", seg=h(1.0), weight=0.1, delay=1)
