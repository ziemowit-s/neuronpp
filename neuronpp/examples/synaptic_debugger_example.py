...
if __name__ == '__main__':
    ...
    syn = cell.add_synapse(source=None, netcon_weight=0.0035, seg=soma(0.5), mod_name="Syn4PAChDa", sign=-1, **cell.params_4p_syn)
    syn.point_process.hoc.e = -90
    
    syn_ach = cell.add_synapse(source=None, seg=soma(0.5), netcon_weight=0.1, mod_name="SynACh")
    syn_da = cell.add_synapse(source=None, seg=soma(0.5), netcon_weight=0.1, mod_name="SynDa")
