...
if __name__ == '__main__':
    ...
    syn = cell.add_synapse(source=None, netcon_weight=WEIGHT, seg=soma(0.5),
                           mod_name="Syn4PAChDa", **cell.params_4p_syn, ACh_tau=1, Da_tau=20, A_Da=1e-3)

    syn_ach = cell.add_synapse(source=None, seg=soma(0.5), netcon_weight=1.0, mod_name="SynACh")
    syn_da = cell.add_synapse(source=None, seg=soma(0.5), netcon_weight=1.0, mod_name="SynDa")
    ...
    debug.add_syn(syn, key_press='w', syn_variables="w Da")
