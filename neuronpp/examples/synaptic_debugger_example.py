...
if __name__ == '__main__':
    ...
    syn = cell.add_sypanse(source=None, weight=0.0035, sec=soma(0.5), mod_name="Syn4PAChDa", **cell.params_4p_syn)
    syn_ach = cell.add_sypanse(source=None, sec=soma(0.5), weight=0.1, mod_name="SynACh")
    syn_da = cell.add_sypanse(source=None, sec=soma(0.5), weight=0.1, mod_name="SynDa")
