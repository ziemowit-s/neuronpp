...
# Create cell
cell = Combe2018Cell(name="cell", spine_number=10, spine_secs_names="apic",
                     spine_seed=13)
...
stdp = Experiment()
stdp.make_protocol("3xEPSP[int=10] 3xAP[int=10,dur=3,amp=1.6]", start=1,
                   isi=10, epsp_synapse=syns[0], i_clamp_section=soma)
...
# Run
sim = Simulation(init_v=-70, warmup=20, with_neuron_gui=True,
