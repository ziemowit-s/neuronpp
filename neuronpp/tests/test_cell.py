...
class TestCellAddSectionDefault(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        cls.dend1 = cls.cell.add_sec("dend1", add_leak=True)
        cls.dend2 = cls.cell.add_sec("dend2", add_leak=True)
    ...
    def test_soma_name(self):
        self.assertEqual("Cell[%s].%s" % (self.cell_name, self.soma.name), self.soma.hoc.name())
...
class TestCellAddSectionLeak(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        cls.dend5 = h.Section("dend", "cell5")
        cls.dend5.insert("pas")
    ...
    def test_cell5_dend(self):
        self.cell5.set_leak(self.dend5, E_leak=-80)
        self.assertEqual(self.dend5.e_pas, -80)

    def test_cell5_dend_rm(self):
        self.cell5.set_leak(self.dend5, Rm=10000)
        self.assertEqual(self.dend5.g_pas, 1 / 10000)

    def test_cell5_dend_g_pas(self):
        self.cell5.set_leak(self.dend5, g_leak=0.02)
        self.assertEqual(self.dend5.g_pas, 0.02)
