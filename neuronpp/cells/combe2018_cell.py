...
class Combe2018Cell(Cell, CoreHocCell):
    def __init__(self, name=None, model_folder="../commons/hocmodels/combe2018", spine_number=0,
        ...
        if spine_number > 0:
            ...
            for h in heads:
                syn = self.add_sypanse(source=None, seg=h(1.0), mod_name="Exp2Syn", weight=ampa_weight)
            ...
            for h in heads:
                syn = self.add_sypanse(source=None, seg=h(1.0), mod_name="nmdanet", weight=nmda_weight)
